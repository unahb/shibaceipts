...
def generate_nft(amount, filename):
    ...
    foreground = Image.open("default_images/glasses" + str(glasses_index) + ".jpg")
    Image.alpha_composite(background, foreground).save("generated_images/composite.jpg")
    ...
    Image.alpha_composite(background, foreground).save("generated_images/final.jpg")
